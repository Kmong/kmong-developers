      ...
      <div>
        ...
        >
          ...
          <button
            ...
            onClick={() => {
              Sentry.startSpan({
                name: 'Lio의 multiple span',
                op: 'multiple span test error'
              }, async () => {
                try {
                    ...
                    const res2 = await fetch("/api/sentry-example-api2");
                    if (!res2.ok) {
                    throw new Error("Lio의 span에서 발생한 error2입니다.");
                    }
                } catch(e) {
          ...
          <p>
            ...
            <a href="https://yuri-ai.sentry.io/issues/?project=4506552392417280">Issues Page</a>.
          </p>
